				...
				.addGroup(gl_contentPane.createSequentialGroup()
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_contentPane.createSequentialGroup()
							...
							.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_contentPane.createSequentialGroup()
									.addComponent(lblName, GroupLayout.PREFERRED_SIZE, 37, Short.MAX_VALUE)
									.addGap(33))
								.addComponent(lblCallNo)
								.addGroup(gl_contentPane.createSequentialGroup()
									.addComponent(lblAuthor, GroupLayout.PREFERRED_SIZE, 37, Short.MAX_VALUE)
									.addGap(33))
								.addComponent(lblPublisher, GroupLayout.PREFERRED_SIZE, 67, Short.MAX_VALUE)
								.addGroup(gl_contentPane.createSequentialGroup()
									.addComponent(lblQuantity, GroupLayout.PREFERRED_SIZE, 55, Short.MAX_VALUE)
									.addGap(15)))
							.addGap(47)
							.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
